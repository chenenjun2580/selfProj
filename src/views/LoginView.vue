...
function handleLogin() {
  ...
  if (username.value === 'root' && password.value === 'Aa123123') {
...
<template>
  <div class="login-page">
    ...
    <form class="form" @submit.prevent="handleLogin">
      ...
      <div id="email-area">
        <input v-model="username" placeholder="USERNAME" id="email" class="input" type="text" />
      </div>
      <div id="password-area">
        <input v-model="password" placeholder="PASSWORD" id="password" class="input" type="password" />
