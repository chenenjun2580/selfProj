...
<template>
  <Teleport to="body">
    <div v-if="visible" class="truck-overlay" @click.self="emit('close')">
      <div class="truck-card">
          ...
          <div class="truck__wheel truck__wheel--front">
            ...
            <div class="truck-wheel">
              <div class="truck-wheel__rim">
                <div v-for="i in 7" :key="i" :style="{ '--index': i - 1 }" class="truck-wheel__spoke"></div>
              </div>
            </div>
          </div>
        ...
        <button class="truck-close-btn" @click="emit('close')">关闭</button>
      </div>
    </div>
  </Teleport>
</template>
