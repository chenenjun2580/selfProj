...
<template>
  ...
  <div class="bear-popup-wrapper" @click.self="$emit('close')">
    <div class="bear-popup-card">
      <div class="bo">
        <div class="face">
          <div class="earL"></div>
          <div class="earR"></div>
      ...
      <button class="bear-close-btn" @click="$emit('close')">关闭</button>
    </div>
  </div>
</template>
...
.bear-close-btn:hover {
  transform: translateY(-2px);
  box-shadow: 5px 5px 0 0 #000;
}

.bear-close-btn:active {
